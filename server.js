...
app.post('/api/products', async (req, res) => {
  ...
  try {
    const query = 'INSERT INTO products (name, category, quantity, price, description) VALUES ($1, $2, $3, $4, $5) RETURNING id';
...
app.put('/api/products/:id', async (req, res) => {
  ...
  try {
    const query = 'UPDATE products SET name = $1, category = $2, quantity = $3, price = $4, description = $5, updated_at = NOW() WHERE id = $6';
